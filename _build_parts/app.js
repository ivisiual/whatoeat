  ...
  var PRESETS = [
    ...
    },
    {
      ...
      meals: {
        ...
        lunch: { channelsAllowed: ["canteen", "takeout"], budgetMax: 30, timeMax: 25, hunger: "normal", mealTypes: ["light", "rice"], mealGoals: ["light", "veggies"] },
  ...
  function defaultMealSetting(meal) {
    if (meal === "breakfast") {
      return {
        ...
        budgetMax: 15, timeMax: 10, hunger: "normal",
        mealTypes: [], mealGoals: [],
    ...
    if (meal === "lunch") {
      return {
        ...
        budgetMax: 30, timeMax: 25, hunger: "normal",
        mealTypes: [], mealGoals: [],
        equipment: "any", prepTime: "any", waitTime: "any"
      };
    }
    return {
      ...
      budgetMax: 30, timeMax: 35, hunger: "normal",
      mealTypes: [], mealGoals: [],
      equipment: "any", prepTime: "any", waitTime: "any"
    };
  }
